...
import { Breadcrumb, BreadcrumbItem, Button, Form, FormGroup, Label, Col, Row, Input, FormFeedback } from 'reactstrap';
...
class Contact extends Component {
    ...
    validate(firstname, lastname, telnum, email) {
        ...
        if(this.state.touched.telnum && !reg.test(telnum)) {
            errors.telnum = 'tel um should contain only numbers'
        }
                    ...
                    <div className="col-12 col-md-9">
                        <Form onSubmit={this.handleSubmit}>
                            ...
                            <FormGroup row>
                                ...
                                <Col md={10}>
                                    <Input typ="text" id="lastname" name="lastname" placeholder="Last Name"
